...
import {
  BasePersonalizeGraphQLSitemapService,
  BaseGraphQLSitemapServiceConfig,
  languageError,
  RouteListQueryResult,
  StaticPath,
} from './base-personalize-graphql-sitemap-service';
 ...
 */
export class MultisitePersonalizeGraphQLSitemapService extends BasePersonalizeGraphQLSitemapService {
  /**
